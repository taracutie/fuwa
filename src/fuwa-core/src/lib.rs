...
pub mod prelude {
    pub use crate::{
        ...
        ExprList, Field, FieldSources, InOperand, InsertConflictBuilder, InsertQuery, IntoExpr,
        NotNull, NotSingleColumn, Nullable, OrderByList, OrderDirection, OrderExpr, RawQuery,
        RenderQuery, RenderedQuery, Result, SelectQuery, Selectable, SqlArrayElement, SqlJsonb,
        SumOutput, Table, TableSource, UpdateQuery, WithBuilder,
    };
}
